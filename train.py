...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default=os.environ['SM_CHANNEL_TRAIN']) #This is the case with Torch's framework_version 1.3.1 but other versions might also be affected.
